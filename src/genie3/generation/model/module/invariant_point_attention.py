...
SE(3)-equivariant attention mechanism for protein structure modeling.
"""
...
from genie3.generation.model.module.primitive import Linear, ipa_point_weights_init_
from genie3.generation.utils.affine_utils import T
from genie3.generation.utils.tensor_utils import (
    permute_final_dims,
    flatten_final_dims,
)
...
class InvariantPointAttention(nn.Module):
    ...
    def __init__(
        ...
        """
        Initialize Invariant Point Attention module.
...
class ReducedInvariantPointAttention(nn.Module):
    """
    Implements Algorithm 22.
    """
    ...
    def __init__(
        ...
        """
        Initialize Reduced Invariant Point Attention module.
        ...
        Args:
            ...
            no_v_points:
                Number of value points to generate
        """
        super(ReducedInvariantPointAttention, self).__init__()
    ...
    def forward(
        ...
        """
        Apply reduced invariant point attention.
        ...
        # [*, N_res, C_s]
        s = self.linear_out(torch.cat((o, o_pair), dim=-1))
