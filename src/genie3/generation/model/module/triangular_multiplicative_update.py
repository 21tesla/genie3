...
Updates pair representations using triangular attention patterns.
"""
...
class TriangleMultiplicativeUpdate(nn.Module):
    ...
    def __init__(self, c_z: int, c_hidden: int, _outgoing: bool = True):
        """
        Initialize triangular multiplicative update module.
    ...
    def _outgoing_matmul(
        ...
        """
        Compute outgoing triangular update via matrix multiplication.

        Args:
            a: Left projection [*, N_i, N_k, C]
            b: Right projection [*, N_j, N_k, C]

        Returns:
            torch.Tensor: Updated pair representation [*, N_i, N_j, C]
        """
        # [*, C, N_i, N_j]
        p = torch.matmul(
    ...
    def _incoming_matmul(
        ...
        """
        Compute incoming triangular update via matrix multiplication.

        Args:
            a: Left projection [*, N_k, N_i, C]
            b: Right projection [*, N_k, N_j, C]
